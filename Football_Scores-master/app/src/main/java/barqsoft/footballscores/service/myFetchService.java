        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                        ...
                        League.equals(PRIMERA_DIVISION)     )
                {
                    ...
                    SimpleDateFormat match_date = new SimpleDateFormat(getString(R.string.format_date_time));
                    match_date.setTimeZone(TimeZone.getTimeZone("UTC"));
                    try {
                        Date parseddate = match_date.parse(mDate+mTime);
                        SimpleDateFormat new_date = new SimpleDateFormat(getString(R.string.format_date_time));
                        ...
                        if(!isReal){
                            ...
                            SimpleDateFormat mformat = new SimpleDateFormat(getString(R.string.format_date_only));
