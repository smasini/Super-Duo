...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.home_crest.setContentDescription(context.getString(R.string.logo) + " " + cursor.getString(COL_HOME));
        mHolder.away_crest.setImageResource(Utilies.getTeamCrestByTeamName(cursor.getString(COL_AWAY)));
        mHolder.away_crest.setContentDescription(context.getString(R.string.logo) + " " + cursor.getString(COL_AWAY));
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            match_day.setContentDescription(Utilies.getMatchDay(cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE), context));
